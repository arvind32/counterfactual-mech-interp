#!/usr/bin/env python3
"""Fail-fast validation for the three-anchor before/after experiment."""
...
def main() -> int:
    ...
    print("THREE-ANCHOR FAIL-FAST SMOKE TEST", flush=True)
    try:
        ...
        required = [
            ...
            ROOT / "run_three_anchor_rollouts.py",
        ...
        import run_three_anchor_rollouts as runner
        ...
        passed(
            ...
            "before/after pairs; seeds 3000–3029",
        )
        ...
        print("Saved: trace_branching_pilot/continuation_3/smoke_report.json")
