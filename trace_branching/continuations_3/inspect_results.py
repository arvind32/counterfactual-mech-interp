#!/usr/bin/env python3
"""Validate three-anchor rollout output and create a review-ready table."""
...
DEFAULT_INPUT = RESULTS_ROOT / "three_anchor_rollouts.jsonl"
DEFAULT_REPORT = RESULTS_ROOT / "three_anchor_integrity.json"
DEFAULT_REVIEW = RESULTS_ROOT / "three_anchor_review.csv"
ANCHORS = ("A", "A_STAR", "C")
